...
# Personal Notes:
#  Move Flow - 
#     - server.request_play (asks particular player to move), -->
#          - sends[turn, board] (sends to greedy_player.py)
#     - greedy_player.py (now in this file)
#          - goes straight to game_socket.recv and pickle.loads to receive/load in the data
#
#  
...
class server:
    ...
    # Server starts listening on same host and port that 'greedy_player.py' is connected
    ...
    # server asks particular player to move
    #  - converts bytes to readable, then sends to each players socket (respectively)
...
# handles what is received from the player socket
#  - recieves [x, y] and stores it in _server.recv_cords to be used in main for move determination
